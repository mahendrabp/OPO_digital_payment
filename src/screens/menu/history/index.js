      ...
      "newResult": [
        {
            ...
            "security_code": "$2b$10$FJgcOifT4m4OWTIIRCJxZOC2wKijmqLUJ1cMjrT1QIzHicuKJOtge",
        ...
        },
        {
            ...
            "name": "Axis",
            "logo": "https://upload.wikimedia.org/wikipedia/commons/8/83/Axis_logo_2015.svg",
            "description": null,
            "merchant_id": "2",
        ...
        },
        {
            ...
            "name": "BPJS",
            "logo": "https://seeklogo.com/images/B/bpjs-kesehatan-logo-B436CE3991-seeklogo.com.png",
            "description": null,
            "merchant_id": "8",
            "user_id": "d8502c57-07f4-463a-bb0d-261047b4db3c",
            "total": 100000,
        ...
        <List>
          {this.state.newResult.map((o,i)=>(
            ...
            <ListItem itemDivider>
              <Text style={{color:'grey', fontSize:12 }}>{o.date.substring(0,10)}</Text>
            </ListItem>
            <ListItem style={{marginLeft:5}}>
            <Body>
              <Text>{o.phone?o.phone:o.name}</Text>
              {o.histType==='transferOut'&&
              <Text note style={{fontSize:12}}>Outcoming Transfer</Text>}
              {o.histType==='transferIn'&&
              <Text note style={{fontSize:12}}>Incoming Transfer</Text>}
              {o.histType==='ppobOut'&&
              <Text note style={{fontSize:12}}>Pembayaran</Text>}
              {o.histType==='ppobIn'&&
              <Text note style={{fontSize:12}}>Rewards</Text>}
            </Body>
            <Right>
              <Text></Text>
              {o.histType==='transferOut'&&
              <Text note style={{color:'green', fontSize:12}}>-Rp{o.nominal}</Text>}
              {o.histType==='transferIn'&&
              <Text note style={{color:'green', fontSize:12}}>+Rp{o.nominal}</Text>}
              {o.histType==='ppobOut'&&o.opo_type==='opo_cash'&&
              <Text note style={{color:'green', fontSize:12}}>-Rp{o.total}</Text>}
              {o.histType==='ppobIn'&&o.opo_type==='opo_cash'&&
              <Text note style={{color:'green', fontSize:12}}>+Rp{o.total}</Text>}
              {o.histType==='ppobOut'&&o.opo_type==='opo_point'&&
              <Text note style={{color:'purple', fontSize:12}}>-OPO Points {o.total}</Text>}
